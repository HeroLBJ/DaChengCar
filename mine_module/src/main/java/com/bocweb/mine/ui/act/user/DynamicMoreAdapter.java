...
import com.bocweb.mine.adapter.IDelegateAdapter;
import com.bocweb.mine.adapter.OneImageAdapter;
import com.bocweb.mine.adapter.SpacesItemDecoration;
import com.bocweb.mine.bean.TargetInfo;
import com.bocweb.mine.bean.UserMsg;
...
public class DynamicMoreAdapter implements IDelegateAdapter<TargetInfo> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View layout = mInflate.inflate(R.layout.mine_adapter_just_now_more, null, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position, TargetInfo item) {
        ...
        UserMsg userInfo = item.getUserInfo();
        if (userInfo != null) {
