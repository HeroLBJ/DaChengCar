package com.bocai.select.photo;
...
import com.bocai.select.photo.adapter.ImagePagerAdapter;
import com.bocai.select.photo.entry.Image;
import com.bocai.select.photo.util.ImageSelector;
import com.bocai.select.photo.view.MyViewPager;
...
@Route(path = RouterHub.Photo.PREVIEW)
public class PreviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Bitmap selectBitmap = BitmapFactory.decodeResource(resources, R.drawable.photo_icon_image_select);
        ...
        Bitmap unSelectBitmap = BitmapFactory.decodeResource(resources, R.drawable.photo_icon_image_un_select);
