...
import com.bocai.select.photo.adapter.FolderAdapter;
import com.bocai.select.photo.adapter.ImageAdapter;
import com.bocai.select.photo.entry.Folder;
import com.bocai.select.photo.entry.Image;
import com.bocai.select.photo.model.ImageModel;
import com.bocai.select.photo.util.DateUtils;
...
@Route(path = RouterHub.Photo.IMAGE_SELECTOR)
