...
import com.bocai.select.photo.util.ImageUtil;
import com.bocai.select.photo.util.StringUtils;
import com.bocai.select.photo.view.ClipImageView;
...
@Route(path = RouterHub.Photo.CLIP_IMAGE)
public class ClipImageActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.photo_activity_clip_image);
